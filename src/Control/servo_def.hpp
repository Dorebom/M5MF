...
#include "Control/Device/can_device_def.hpp"

#define SERVO_NUM 3
#define POSE_DIM  3

#define FORCE_SENSOR_CAN_ID 0x20

struct ServoInfo
{
    /* data */
    uint8_t can_id[SERVO_NUM];
    CanDeviceType servo_type[SERVO_NUM];
    ...
    ServoInfo() {
        ...
        can_id[1] = 12;
        can_id[2] = 13;
        servo_type[0] = CanDeviceType::CYBERGEAR;
        servo_type[1] = CanDeviceType::CYBERGEAR;
        servo_type[2] = CanDeviceType::CYBERGEAR;
